...
public class IndividualTest {
    ...
    void testRecombineOneChromosome() {
        List<Segment> segs1 = Arrays.asList(make(0, 5), make(10, 15));
        List<Segment> segs2 = Arrays.asList(make(3, 4), make(12, 14));
        List<Integer> indices = new ArrayList<>(Arrays.asList(2, 6, 10));
        List<Segment> expected1 = Arrays.asList(make(0, 2), make(3, 4), make(12, 14));
        List<Segment> expected2 = Arrays.asList(make(2, 5), make(10, 15));
        ...
        segs1 = Arrays.asList(make(0, 10));
        segs2 = Arrays.asList(make(0, 10));
        indices = new ArrayList<>(Arrays.asList(0, 4, 6, 9, 10));
        expected1 = Arrays.asList(make(0, 4), make(4, 6), make(6, 9), make(9, 10));
        recombined = recombineOneChromosome(segs1, segs2, indices);
        assertEquals(expected1, recombined);

        segs1 = Arrays.asList(make(4, 5), make(20, 40), make(43, 60), make(61, 70));
        segs2 = Arrays.asList(make(1, 3), make(10, 20), make(30, 33), make(80, 90));
        indices = new ArrayList<>(Arrays.asList(0, 4, 20, 44, 68, 91, 102));
        expected1 = Arrays.asList(make(1, 3), make(4, 5), make(30, 33), make(44, 60), make(61, 68), make(80, 90));
        expected2 = Arrays.asList(make(10, 20), make(20, 40), make(43, 44), make(68, 70));
        recombined = recombineOneChromosome(segs1, segs2, indices);
        assertTrue(recombined.equals(expected1) || recombined.equals(expected2));
    }
